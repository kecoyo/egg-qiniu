...
class Qiniu {
  constructor(config, app) {
    ...
    if (this.isLog) {
      this.app.coreLogger.info('[egg-qiniu] create one instance');
    }
  }
  ...
  async _UPLOAD(key, file, style) {
    ...
    return new Promise((resolved, reject) => {
      formUploader[style](token, key, file, putExtra, (err, respBody, respInfo) => {
        ...
        if (this.isLog) {
          this.app.coreLogger.info(`[egg-qiniu] _upload, respBody: ${JSON.stringify(respBody)}`);
          this.app.coreLogger.info(`[egg-qiniu] _upload, respInfo: ${JSON.stringify(respInfo)}`);
        }

        if (err) {
          this.app.coreLogger.error(`[egg-qiniu] _upload, e: ${err}`);
          reject(err);
        } else {
          if (respInfo.statusCode !== 200 && this.isLog) {
            this.app.coreLogger.info(`[egg-qiniu] _upload, statusCode: ${respInfo.statusCode}`);
  ...
  async _OP(style, key) {
    return new Promise((resolved, reject) => {
      ...
      bucketManager[style](this.bucket, key, (err, respBody, respInfo) => {
        ...
        if (this.isLog) {
          this.app.coreLogger.info(`[egg-qiniu] _OP, style: ${style}, respBody: ${JSON.stringify(respBody)}`);
          this.app.coreLogger.info(`[egg-qiniu] _OP, style: ${style}, respInfo: ${JSON.stringify(respInfo)}`);
        }
        ...
        if (err) {
          ...
          if (respInfo.statusCode !== 200 && this.isLog) {
            this.app.coreLogger.info(`[egg-qiniu] _OP, style: ${style}, statusCode: ${respInfo.statusCode}`);
            reject(respBody.error);
          }
  ...
  async changeType(key, newType) {
    return new Promise((resolved, reject) => {
      ...
      bucketManager.changeType(this.bucket, key, newType, (err, respBody, respInfo) => {
        ...
        if (this.isLog) {
          this.app.coreLogger.info(`[egg-qiniu] changeType, respBody: ${JSON.stringify(respBody)}`);
          this.app.coreLogger.info(`[egg-qiniu] changeType, respInfo: ${JSON.stringify(respInfo)}`);
        }
        ...
        if (err) {
          ...
          if (respInfo.statusCode !== 200 && this.isLog) {
            this.app.coreLogger.info(`[egg-qiniu] changeType, statusCode: ${respInfo.statusCode}`);
            reject(respBody.error);
          }
          // statusCode 不为 200，请查看 respBody.error
          resolved({
  ...
  async _MC(style, srcKey, destBucket, destKey, isForce) {
    return new Promise((resolved, reject) => {
      ...
      bucketManager[style](this.bucket, srcKey, destBucket, destKey, options, (err, respBody, respInfo) => {
        ...
        if (this.isLog) {
          this.app.coreLogger.info(`[egg-qiniu] _MC, style: ${style}, respBody: ${JSON.stringify(respBody)}`);
          this.app.coreLogger.info(`[egg-qiniu] _MC, style: ${style}, respInfo: ${JSON.stringify(respInfo)}`);
        }
        ...
        if (err) {
          ...
          if (respInfo.statusCode !== 200 && this.isLog) {
            this.app.coreLogger.info(`[egg-qiniu] _MC, style: ${style}, statusCode: ${respInfo.statusCode}`);
            reject(respBody.error);
          }
          // statusCode 不为 200，请查看 respBody.error
          resolved({
  ...
  async deleteAfterDays(key, days) {
    return new Promise((resolved, reject) => {
      ...
      bucketManager.deleteAfterDays(this.bucket, key, days, (err, respBody, respInfo) => {
        // respBody: null
        if (this.isLog) {
          this.app.coreLogger.info(`[egg-qiniu] deleteAfterDays, respBody: ${JSON.stringify(respBody)}`);
          this.app.coreLogger.info(`[egg-qiniu] deleteAfterDays, respInfo: ${JSON.stringify(respInfo)}`);
        }
        if (err) {
          reject(err);
        } else {
          if (respInfo.statusCode !== 200 && this.isLog) {
            this.app.coreLogger.info(`[egg-qiniu] deleteAfterDays, statusCode: ${respInfo.statusCode}`);
            reject(respBody.error);
          }
          // statusCode 不为 200，请查看 respBody.error
          resolved({
  ...
  async listPrefix({ prefix, marker, limit, delimiter }) {
    ...
    return new Promise((resolved, reject) => {
      ...
      bucketManager.listPrefix(this.bucket, options, (err, respBody, respInfo) => {
        ...
        if (this.isLog) {
          this.app.coreLogger.info(`[egg-qiniu] listPrefix, respBody: ${JSON.stringify(respBody)}`);
          this.app.coreLogger.info(`[egg-qiniu] listPrefix, respInfo: ${JSON.stringify(respInfo)}`);
        }
        if (err) {
          reject(err);
        } else {
          if (respInfo.statusCode !== 200 && this.isLog) {
            this.app.coreLogger.info(`[egg-qiniu] listPrefix, statusCode: ${respInfo.statusCode}`);
            reject(respBody.error);
          }
          // statusCode 不为 200，请查看 respBody.error
          resolved({
  ...
  async fetch(url, key) {
    return new Promise((resolved, reject) => {
      ...
      bucketManager.fetch(url, this.bucket, key, (err, respBody, respInfo) => {
        ...
        if (this.isLog) {
          this.app.coreLogger.info(`[egg-qiniu] fetch, respBody: ${JSON.stringify(respBody)}`);
          this.app.coreLogger.info(`[egg-qiniu] fetch, respInfo: ${JSON.stringify(respInfo)}`);
        }
        if (err) {
          reject(err);
        } else {
          if (respInfo.statusCode !== 200 && this.isLog) {
            this.app.coreLogger.info(`[egg-qiniu] fetch, statusCode: ${respInfo.statusCode}`);
            reject(respBody.error);
          }
          // statusCode 不为 200，请查看 respBody.error
          resolved({
  ...
  async _BATCH_OP(style, files) {
    ...
    return new Promise((resolved, reject) => {
      ...
      bucketManager.batch(options, (err, respBody, respInfo) => {
        if (this.isLog) {
          this.app.coreLogger.info(`[egg-qiniu] _BATCH_OP, style: ${style}, respBody: ${JSON.stringify(respBody)}`);
          this.app.coreLogger.info(`[egg-qiniu] _BATCH_OP, style: ${style}, respInfo: ${JSON.stringify(respInfo)}`);
        }
        if (err) {
          reject(err);
        } else {
          if (respInfo.statusCode !== 200 && this.isLog) {
            this.app.coreLogger.info(`[egg-qiniu] _BATCH_OP, style: ${style}, statusCode: ${respInfo.statusCode}`);
            reject(respBody.error);
          }
          // statusCode 不为 200，请查看 respBody.error
          resolved({
  ...
  refreshUrls(urls) {
    return new Promise((resolved, reject) => {
      ...
      cdnManager.refreshUrls(urls, (err, respBody, respInfo) => {
        ...
        // }
        if (this.isLog) {
          this.app.coreLogger.info(`[egg-qiniu] refreshUrls, respBody: ${JSON.stringify(respBody)}`);
          this.app.coreLogger.info(`[egg-qiniu] refreshUrls, respInfo: ${JSON.stringify(respInfo)}`);
        }
        if (err) {
          reject(err);
        } else {
          if (respInfo.statusCode !== 200 && this.isLog) {
            this.app.coreLogger.info(`[egg-qiniu] refreshUrls, statusCode: ${respInfo.statusCode}`);
            reject(respBody.error);
          }
          // statusCode 不为 200，请查看 respBody.error
          resolved({
  ...
  refreshDirs(dirs) {
    return new Promise((resolved, reject) => {
      ...
      cdnManager.refreshDirs(dirs, (err, respBody, respInfo) => {
        if (this.isLog) {
          this.app.coreLogger.info(`[egg-qiniu] refreshDirs, respBody: ${JSON.stringify(respBody)}`);
          this.app.coreLogger.info(`[egg-qiniu] refreshDirs, respInfo: ${JSON.stringify(respInfo)}`);
        }
        if (err) {
          reject(err);
        } else {
          if (respInfo.statusCode !== 200 && this.isLog) {
            this.app.coreLogger.info(`[egg-qiniu] refreshDirs, statusCode: ${respInfo.statusCode}`);
            reject(respBody.error);
          }
          // statusCode 不为 200，请查看 respBody.error
          resolved({
  ...
  prefetchUrls(urls) {
    return new Promise((resolved, reject) => {
      ...
      cdnManager.prefetchUrls(urls, (err, respBody, respInfo) => {
        if (this.isLog) {
          this.app.coreLogger.info(`[egg-qiniu] prefetchUrls, respBody: ${JSON.stringify(respBody)}`);
          this.app.coreLogger.info(`[egg-qiniu] prefetchUrls, respInfo: ${JSON.stringify(respInfo)}`);
        }
        if (err) {
          reject(err);
        } else {
          if (respInfo.statusCode !== 200 && this.isLog) {
            this.app.coreLogger.info(`[egg-qiniu] prefetchUrls, statusCode: ${respInfo.statusCode}`);
            reject(respBody.error);
          }
          // statusCode 不为 200，请查看 respBody.error
          resolved({
  ...
  getFluxData(startDate, endDate, domains) {
    return new Promise((resolved, reject) => {
      ...
      cdnManager.getFluxData(startDate, endDate, 'day', domains, (err, respBody, respInfo) => {
        if (this.isLog) {
          this.app.coreLogger.info(`[egg-qiniu] getFluxData, respBody: ${JSON.stringify(respBody)}`);
          this.app.coreLogger.info(`[egg-qiniu] getFluxData, respInfo: ${JSON.stringify(respInfo)}`);
        }
        if (err) {
          reject(err);
        } else {
          if (respInfo.statusCode !== 200 && this.isLog) {
            this.app.coreLogger.info(`[egg-qiniu] getFluxData, statusCode: ${respInfo.statusCode}`);
            reject(respBody.error);
          }
          // statusCode 不为 200，请查看 respBody.error
          resolved({
  ...
  getBandwidthData(startDate, endDate, domains) {
    return new Promise((resolved, reject) => {
      ...
      cdnManager.getBandwidthData(startDate, endDate, 'day', domains, (err, respBody, respInfo) => {
        if (this.isLog) {
          this.app.coreLogger.info(`[egg-qiniu] getBandwidthData, respBody: ${JSON.stringify(respBody)}`);
          this.app.coreLogger.info(`[egg-qiniu] getBandwidthData, respInfo: ${JSON.stringify(respInfo)}`);
        }
        if (err) {
          reject(err);
        } else {
          if (respInfo.statusCode !== 200 && this.isLog) {
            this.app.coreLogger.info(`[egg-qiniu] getBandwidthData, statusCode: ${respInfo.statusCode}`);
            reject(respBody.error);
          }
          // statusCode 不为 200，请查看 respBody.error
          resolved({
  ...
  getCdnLogList(logDay, domains) {
    return new Promise((resolved, reject) => {
      ...
      cdnManager.getCdnLogList(domains, logDay, (err, respBody, respInfo) => {
        if (this.isLog) {
          this.app.coreLogger.info(`[egg-qiniu] getCdnLogList, respBody: ${JSON.stringify(respBody)}`);
          this.app.coreLogger.info(`[egg-qiniu] getCdnLogList, respInfo: ${JSON.stringify(respInfo)}`);
        }
        if (err) {
          reject(err);
        } else {
          if (respInfo.statusCode !== 200 && this.isLog) {
            this.app.coreLogger.info(`[egg-qiniu] getCdnLogList, statusCode: ${respInfo.statusCode}`);
            reject(respBody.error);
          }
          // statusCode 不为 200，请查看 respBody.error
          resolved({
...
function createOneClient(config, app) {
  assert(
    ...
    `[egg-qiniu] 'config.ak: ${config.ak}', 'config.sk: ${config.sk}', 'config.zone: ${config.zone}', 'config.bucket: ${config.bucket}' are required`,
  );
