...
[npm-image]: https://img.shields.io/npm/v/@kecoyo/egg-qiniu.svg?style=flat-square
[npm-url]: https://npmjs.org/package/@kecoyo/egg-qiniu
[travis-image]: https://img.shields.io/travis/kecoyo/egg-qiniu.svg?style=flat-square
[travis-url]: https://travis-ci.org/kecoyo/egg-qiniu
[codecov-image]: https://img.shields.io/codecov/c/github/kecoyo/egg-qiniu.svg?style=flat-square
[codecov-url]: https://codecov.io/github/kecoyo/egg-qiniu?branch=master
[david-image]: https://img.shields.io/david/kecoyo/egg-qiniu.svg?style=flat-square
[david-url]: https://david-dm.org/kecoyo/egg-qiniu
[snyk-image]: https://snyk.io/test/npm/@kecoyo/egg-qiniu/badge.svg?style=flat-square
[snyk-url]: https://snyk.io/test/npm/@kecoyo/egg-qiniu
[download-image]: https://img.shields.io/npm/dm/@kecoyo/egg-qiniu.svg?style=flat-square
[download-url]: https://npmjs.org/package/@kecoyo/egg-qiniu
...
- 通过`app.qiniu`调用函数，在配置文件中已经固定`bucket`
...
- 多实例中
  ...
  ```js
  const image = app.qiniu.get('myImage');
  const imageBak = app.qiniu.get('myImageBak');
